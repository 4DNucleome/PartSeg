...
def test_analysis_import():
    try:
        import PartSeg._roi_analysis.main_window  # noqa: F401, PLC0415
...
def test_launcher_import():
    try:
        import PartSeg._launcher.main_window  # noqa: F401, PLC0415
    except ImportError:  # pragma: no cover
...
def test_segmentation_import():
    try:
        import PartSeg._roi_mask.main_window  # noqa: F401, PLC0415
    except ImportError:  # pragma: no cover
