...
from PartSegCore.analysis.calculation_plan import CalculationPlan, CalculationTree, MaskSuffix, MeasurementCalculate, \
    Calculation, RootType, MaskCreate
...
class TestCalculationProcess:
    ...
    def create_calculation_plan():
        parameters = {"channel": 1, "minimum_size": 200,
                      ...
                      'noise_filtering': {'name': 'Gauss', 'values':
                                          {'dimension_type': DimensionType.Layer, "radius": 1.0}},
        ...
        statistic_calculate = MeasurementCalculate(channel=0, units=Units.µm,
                                                   statistic_profile=statistic, name_prefix="")
        tree = CalculationTree(RootType.Image,
    ...
    def create_calculation_plan2():
        parameters = {"channel": 0, "minimum_size": 200,
                      'threshold': {'name': 'Base/Core',
                                    'values': {
                                        'core_threshold': {'name': 'Manual', 'values': {'threshold': 30000}},
                                        'base_threshold': {'name': 'Manual', 'values': {'threshold': 13000}}}},
            ...
            name="Volume", area=AreaType.Segmentation, per_component=PerComponent.No)),
                         ...
                         MeasurementEntry("Segmentation Components Number",
                                          calculation_tree=Leaf("Components Number", area=AreaType.Segmentation,
                                                                per_component=PerComponent.No))]
        statistic = MeasurementProfile(name="base_measure", chosen_fields=chosen_fields, name_prefix="")
        statistic_calculate = MeasurementCalculate(channel=0, units=Units.µm, statistic_profile=statistic,
                                                   name_prefix="")
    ...
    def create_calculation_plan3():
        ...
        chosen_fields = [MeasurementEntry(name="Segmentation Volume", calculation_tree=Leaf(
            name="Volume", area=AreaType.Segmentation, per_component=PerComponent.No)),
                         ...
                         MeasurementEntry("Segmentation Components Number",
                                          calculation_tree=Leaf("Components Number", area=AreaType.Segmentation,
                                                                per_component=PerComponent.No)),
                         MeasurementEntry("Segmentation Volume per component",
                                          calculation_tree=Leaf("Volume", area=AreaType.Segmentation,
        ...
        parameters2 = {"channel": 1, "minimum_size": 200,
        ...
        chosen_fields = [MeasurementEntry(name="Segmentation Volume", calculation_tree=Leaf(
            name="Volume", area=AreaType.Segmentation, per_component=PerComponent.No)),
                         ...
                         MeasurementEntry("Segmentation Components Number",
                                          calculation_tree=Leaf("Components Number", area=AreaType.Segmentation,
                                                                per_component=PerComponent.No)),
                         MeasurementEntry("Mask Volume per component",
                                          calculation_tree=Leaf("Volume", area=AreaType.Mask,
                                                                per_component=PerComponent.Yes))
                         ]
        statistic = MeasurementProfile(name="base_measure2", chosen_fields=chosen_fields[:], name_prefix="aa_")
        statistic_calculate2 = MeasurementCalculate(channel=0, units=Units.µm,
                                                    statistic_profile=statistic, name_prefix="")
        chosen_fields.append(MeasurementEntry("Segmentation Volume per component",
                                              calculation_tree=Leaf("Volume", area=AreaType.Segmentation,
                                                                    per_component=PerComponent.Yes)))
        statistic = MeasurementProfile(name="base_measure3", chosen_fields=chosen_fields[:], name_prefix="bb_")
        statistic_calculate3 = MeasurementCalculate(channel=0, units=Units.µm,
                                                    statistic_profile=statistic, name_prefix="")
