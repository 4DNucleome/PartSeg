...
class TestInterpolateImage:
    def test_simple(self):
        ...
        image_res = InterpolateImage.transform(image, None, {"scale": 1})
    ...
    def test_nonzero_border(self):
        ...
        image_res = InterpolateImage.transform(image, None, {"scale": 2})
    ...
    def test_default_interpolate(self):
        image = get_flat_image()
        image_res = InterpolateImage.transform(image, None, InterpolateImage.calculate_initial(image))
    ...
    def test_multiple_interpolate(self):
        image = get_cube_image()
        image_res = InterpolateImage.transform(image, None, {"scale_x": 2, "scale_y": 3, "scale_z": 4})
