...
#
#
# def create_napari_colormap(colormap: BaseColormap, name: str) -> NapariColormap:
#     return convert_vispy_colormap(VispyColormap(VispyColorArray(create_color_map(colormap))), name)
#
#
...
# _white = Color(1, 1, 1)
#
# inferno = ArrayColorMap(inferno_data, 1)
# inferno_r = ArrayColorMap(reversed(inferno_data), 1)
# magma = ArrayColorMap(magma_data, 1)
# magma_r = ArrayColorMap(reversed(magma_data), 1)
# plasma = ArrayColorMap(plasma_data, 1)
# plasma_r = ArrayColorMap(reversed(plasma_data), 1)
# viridis = ArrayColorMap(viridis_data, 1)
# viridis_r = ArrayColorMap(reversed(viridis_data), 1)
#
#
# base_colors = [
#     ("Red", Color(1, 0, 0)),
