from .base_colors import Color, ColorPosition, default_colormap_dict, ColorMap, BaseColormap, \
    default_label_dict, LabelColors
...
__all__ = ("color_image_fun", "add_labels", "create_color_map", "default_colormap_dict", "Color", "ColorPosition",
           "ColorMap", "BaseColormap", "resolution", "default_label_dict", "LabelColors")
