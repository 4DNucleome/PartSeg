...
class Volume(MeasurementMethodBase):
    ...
    @classmethod
    def calculate_property(cls, area_array, voxel_size, result_scalar, **_):  # pylint: disable=argument-differ
...
class Voxels(MeasurementMethodBase):
    ...
    @classmethod
    def calculate_property(cls, area_array, **_):  # pylint: disable=argument-differ
...
class Diameter(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array, voxel_size, result_scalar, **_):  # pylint: disable=argument-differ
...
class PixelBrightnessSum(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array: np.ndarray, channel: np.ndarray, **_):  # pylint: disable=argument-differ
        """
...
class ComponentsNumber(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array, **_):  # pylint: disable=argument-differ
...
class MaximumPixelBrightness(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array, channel, **_):  # pylint: disable=argument-differ
...
class Moment(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array, channel, voxel_size, **_):  # pylint: disable=argument-differ
        if len(channel.shape) == 4:
...
class FirstPrincipalAxisLength(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(**kwargs):  # pylint: disable=argument-differ
...
class RimVolume(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(area_array, voxel_size, result_scalar, **kwargs):  # pylint: disable=argument-differ
...
class RimPixelBrightnessSum(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(channel, area_array, **kwargs):  # pylint: disable=argument-differ
        if len(channel.shape) == 4:
            if channel.shape[0] != 1:  # pragma: no cover
                raise ValueError("This measurements do not support time data")
            channel = channel[0]
...
class DistanceMaskROI(MeasurementMethodBase):
    ...
    @classmethod
    def calculate_property(  # pylint: disable=argument-differ
        cls,
        channel,
        area_array,
        mask,
...
class SplitOnPartPixelBrightnessSum(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(part_selection, channel, area_array, **kwargs):  # pylint: disable=argument-differ
...
class ComponentBoundingBox(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(bounds_info, _component_num, **kwargs):  # pylint: disable=argument-differ
...
class GetROIAnnotationType(MeasurementMethodBase):
    ...
    @staticmethod
    def calculate_property(roi_annotation, name, _component_num, **kwargs):  # pylint: disable=argument-differ
...
class VoxelSize(MeasurementMethodBase):
    ...
    @classmethod
    def calculate_property(cls, voxel_size, result_scalar, **kwargs):  # pylint: disable=argument-differ
