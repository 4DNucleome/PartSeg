...
cdef extern from 'mso.h' namespace 'MSO':
    cdef cppclass MSO[T, M]:
        ...
        void max_path_calculate(vector[M] &fdt_array, vector[T] &components_arr, vector[bool] sprawl_area)
        size_t get_length()
...
cdef class PyMSO:
    ...
    def max_path_calculate(self, numpy.ndarray[mu_type, ndim=3] fdt_array,
                           numpy.ndarray[component_type, ndim=3] components_arr,
                           numpy.ndarray[bool, ndim=3] sprawl_area):
