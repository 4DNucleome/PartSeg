...
from PartSeg.utils.algorithm_describe_base import AlgorithmDescribeBase, AlgorithmProperty, Register
from PartSeg.utils.segmentation.sprawl import get_neighbourhood, NeighType
